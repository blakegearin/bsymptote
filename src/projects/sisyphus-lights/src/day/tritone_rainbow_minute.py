#!/usr/bin/env python3
# Name: Tritone Rainbow Day
# Author: Blake Gearin (blakegearin@pm.me)
#
# Description: Three color rainbow cycle based on the time of day
...
def update(strip, table_values):
    ...
    daily_seconds_to_wheel_deg_ratio = 338.823529
    wheel_deg = int(round(seconds_since_midnight / daily_seconds_to_wheel_deg_ratio))

    for i in range(0,led_count):
        wheel_deg = multitone_wheel_deg(3, i, wheel_deg)
